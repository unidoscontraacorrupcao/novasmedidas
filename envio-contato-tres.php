...
<div style="display: none;">
  <script> location.replace("http://unidoscontraacorrupcao.org.br/index.html?mensagemtres=oktres#okRespForm"); </script>
    ...
    <tr>
      <td><table width='90%' border='0' align='center' cellpadding='0' cellspacing='0' style=' margin: 0 auto;'>
          <tbody>
            ...
            <tr>
              <td><strong>Email:</strong> ".$_POST["cep"]." </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td><strong>Email:</strong> ".$_POST["celular"]." </td>
            </tr>
            <tr>
              <td>&nbsp;</td>
            </tr>
...
if (smtpmailer('assine.unidoscontraacorrupcao@gmail.com ', $_POST["email"], 'As Novas Medidas', 'Assinatura pelo Site', $Vai)) {
  ?>
  <script> location.replace("http://unidoscontraacorrupcao.org.br/index.html?mensagemtres=oktres#okRespForm"); </script>
  <?php
}else{
